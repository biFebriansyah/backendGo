...
func (r *prod_repo) GetById(uid string) (*models.Products, error) {
...
func (r *prod_repo) DeleteByid(uid string) (*models.Products, error) {

	var data models.Products

	result := r.db.Where("product_id = ?", uid).Delete(&data)
